...
<div class="ocs__links ocs__links--wide">
    <a class="ocs__btn ocs__btn--icon ocs__btn--alert-green" href="https://opencodingsociety.com">
        <span class="ocs__btn-icon" aria-hidden="true">
            <img src="{{ '/favicon.ico' | relative_url }}" alt="">
        </span>
        <span>OCS</span>
    </a>
    <a class="ocs__btn ocs__btn--icon ocs__btn--alert-yellow" href="https://github.com/Open-Coding-Society/portfolio">
        <span class="ocs__btn-icon" aria-hidden="true">
    ...
    <a class="ocs__btn ocs__btn--icon ocs__btn--alert-red" href="https://vscode.dev/">
        <span class="ocs__btn-icon" aria-hidden="true">
            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
<div class="ocs__links">
    ...
    <a class="ocs__btn iridescent" href="{{site.baseurl}}/game/essentials/variables">
        JS Variables
    </a>
    <a class="ocs__btn iridescent" href="">
        Gamerunner
    </a>
    <a class="ocs__btn iridescent" href="{{site.baseurl}}/gamerunner">
        Gamerunner
    </a>
    <a class="ocs__btn iridescent" href="{{site.baseurl}}/network/stack">
        Networking
    </a>
</div>
...
<div class="ocs__links">
    <a href="{{site.baseurl}}/snake" class="ocs__btn ocs__btn--alert-green ocs__btn--alert-fill">
        Snake
    </a>
    <a href="{{site.baseurl}}/gamify/parallax" class="ocs__btn ocs__btn--alert-yellow ocs__btn--alert-fill">
        Fish
    </a>
    <a href="{{site.baseurl}}/gamify" class="ocs__btn ocs__btn--alert-red ocs__btn--alert-fill">
        Gamify
    </a>
    <a href="{{site.baseurl}}/cs-pathway" class="ocs__btn">
        CS Pathway
    </a>
</div>
