...
description: >
  Three skeleton versions of putting calendar events straight into the class
  announcements, side by side, so we can pick one to build out.
...
- Which version fits how you plan the week? Would a mix work, for example V1's button with V3's strip?
